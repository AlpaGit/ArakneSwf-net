...
/// <summary>
/// Filtre de biseau dégradé (GradientBevelFilter).
/// </summary>
public sealed class GradientBevelFilter : Filter
{
    public const byte FILTER_ID = 7;
    ...
    /// <summary>Lit un <see cref="GradientBevelFilter"/> depuis le flux SWF.</summary>
    public static GradientBevelFilter Read(SwfReader reader)
    {
